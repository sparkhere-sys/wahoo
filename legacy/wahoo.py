...
def main():
  ...
  print(f"{wahoo_warn}wahoo warn: {reset}THIS VERSION OF WAHOO IS DEPRECATED")
  prompt("Are you sure you want to continue?", yolo=False, exit_on_abort=False, use_msg_as_prompt=True)
